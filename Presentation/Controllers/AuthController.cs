...
namespace EmsSystem.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public IActionResult Login([FromBody] LoginDto request)
        {
            ...
            if (!isValidPassword)
                return Unauthorized(ApiResponse<object>.FailResponse("Wrong password"));
    ...
    [FromForm] UserAssetDto userAssetDto)
        {
            ...
            if (string.IsNullOrEmpty(userId))
                return Unauthorized(ApiResponse<object>.FailResponse("Unauthorized"));
            ...
            {
                return BadRequest(ApiResponse<object>.FailResponse("First name cannot be empty"));
            }
            if (string.IsNullOrEmpty(dto.LastName))
            {
                return BadRequest(ApiResponse<object>.FailResponse("Last name cannot be empty"));
            }
            ...
            return Ok(ApiResponse<object>.SuccessResponse(result, "User profile updated successfully"));
        }
